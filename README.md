...
不同于传统任务管理工具,ScholarFlow 让每一项科研资产(日程、项目、实验、文献、论文、成果)互相联动、随时可查、完整可导出。在一个项目的论证当中，可以通过关联模块，快速调用相关文件。
...
| 🤖 AI 助手（尚未完成MCP调用模块的更新） | 调用 DeepSeek,科研问答与写作辅助 |
...
- **月历/周计划**:显示日程、任务与重要节点标记;点击日期 → 今日计划 = 该日**日程 + 任务 + 倒计时节点**同步显示
...
![项目管理](public/figure/微信图片_20260808213317_30_114.png)
...
![实验中心](public/figure/微信图片_20260808213335_31_114.png)
...
![文献证据](public/figure/微信图片_20260808213410_33_114.png)
...
1. 下载 **Releases** 里的最新版`ScholarFlow-v1.0.x-win32-x64.zip`
